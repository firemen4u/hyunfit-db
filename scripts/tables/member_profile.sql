CREATE TABLE member_profile (
	...
	mbrp_exercise_preference	NUMBER		NULL,
...
COMMENT ON COLUMN member_profile.mbrp_exercise_goal IS '운동 목표 설문 1: ,2: ,3:';
COMMENT ON COLUMN member_profile.mbrp_exercise_experience_level IS '운동 경력 1: 초보자 2: 중급자 3: 고수';
COMMENT ON COLUMN member_profile.mbrp_exercise_preference IS '선호 운동 1: 헬스 2: 요가 3: 필라테스 등';
