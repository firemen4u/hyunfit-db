CREATE TABLE trainer_feedback (
	trnf_seq	NUMBER	DEFAULT trnf_seq_pk.NEXTVAL	NOT NULL,
	...
	trnf_submission_due	TIMESTAMP	NOT NULL
);


COMMENT ON COLUMN trainer_feedback.trn_seq IS 'trn_seq_pk.NEXTVAL';
...
COMMENT ON COLUMN trainer_feedback.trnf_submission_due IS '트레이너가 피드백을 작성해야 하는 기간';
